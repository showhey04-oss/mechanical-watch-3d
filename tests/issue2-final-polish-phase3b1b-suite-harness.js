...
const output = document.getElementById("issue2Phase3B1bSuiteResult");
const log = document.getElementById("issue2Phase3B1bSuiteLog");
...
const candidate =
  params.get("candidate") || "issue2-phase3b1b-state-tight-512";
...
async function publish(result, resultStatus) {
  ...
  if (resultStatus === "passed" || resultStatus === "failed") {
    ...
    const path =
      "docs/evidence/issue2-final-polish-phase3b1b-discrete-shadow/reports/" +
