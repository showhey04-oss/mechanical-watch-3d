...
const output = document.getElementById("issue2Phase3B1SuiteResult");
const log = document.getElementById("issue2Phase3B1SuiteLog");
...
const candidate =
  params.get("candidate") || "issue2-phase3b1-baseline";
...
async function publish(result, status) {
  ...
  if (status === "passed" || status === "failed") {
    ...
    const path =
      "docs/evidence/issue2-final-polish-phase3b1-shadow-fog/reports/" +
