...
const queries = {
  normal: {},
  phase3c1: { exterior: "balanced", watchHead: "phase3c1" },
  phase3c2: {
    exterior: "balanced",
    watchHead: "phase3c1",
    strapStyle: "phase3c2",
  },
  phase3c3: completedExterior,
  "phase3a-baseline": { ...completedExterior, rendering: "issue2-baseline" },
  "phase3a-d2a": { ...completedExterior, rendering: "issue2-d2a" },
  "phase3a-d2c3": { ...completedExterior, rendering: "issue2-d2c3" },
  "phase3b1-baseline": {
    ...completedExterior,
  ...
  "phase3b1-shadow-fit": {
    ...completedExterior,
    rendering: "issue2-shadow-fit",
  },
  "phase3b1-fog-only": {
    ...completedExterior,
    rendering: "issue2-fog-only",
  },
  "phase3b1-shadow-off-fog": {
    ...completedExterior,
    rendering: "issue2-shadow-off-fog",
  },
  "phase3b1-shadow-fit-fog": {
    ...completedExterior,
    rendering: "issue2-shadow-fit-fog",
  },
  "phase3b1b-baseline": {
    ...completedExterior,
    rendering: "issue2-phase3b1b-baseline",
  },
  "phase3b1b-shadow-off": {
    ...completedExterior,
    rendering: "issue2-phase3b1b-shadow-off",
  },
  "phase3b1b-tight-512": {
    ...completedExterior,
    rendering: "issue2-state-tight-512",
  },
  "phase3b1b-tight-1024": {
    ...completedExterior,
    rendering: "issue2-state-tight-1024",
  },
  "phase3b1c-baseline": {
    ...completedExterior,
    rendering: "issue2-phase3b1c-baseline",
  },
  "phase3b1c-shadow-off": {
    ...completedExterior,
    rendering: "issue2-phase3b1c-shadow-off",
  },
  "phase3b1c-attenuation": {
    ...completedExterior,
    rendering: "issue2-shadow-attenuation",
  },
  "phase3b1c-attenuation-bias": {
    ...completedExterior,
    rendering: "issue2-shadow-attenuation-bias",
  },
};
...
const waitFor = async (test, timeoutMs = 240_000) => {
  ...
  throw new Error("timed out waiting for Phase 3B.2 protected path");
};
...
(async () => {
  ...
  if (diagnostics.getIssue2Phase3B2State().enabled) {
    throw new Error("protected path unexpectedly enabled Phase 3B.2");
  }
