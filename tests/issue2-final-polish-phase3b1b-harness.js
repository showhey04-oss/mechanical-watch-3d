...
const output = document.getElementById("issue2Phase3B1bResult");
...
const waitFor = async (test, timeoutMs = 60_000) => {
  ...
  throw new Error("timed out waiting for Phase 3B.1b diagnostics");
};
...
const evidencePath = (...segments) =>
  [
    "docs",
    "evidence",
    "issue2-final-polish-phase3b1b-discrete-shadow",
...
(async () => {
  ...
  const report = {
    ...
    stateBounds: diagnostics.getIssue2Phase3B1bStateBoundsReport(),
