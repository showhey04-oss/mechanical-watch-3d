...
現在の改修フェーズは「最終外装統合 — Phase 3B.2 基本装着部候補」とする。Phase 3B.2は人間承認済みPhase 3B.1 Head `d51e4f8790596f7bc894e8c716edb0d54968d260`へ積み上げる別Draftであり、既定採用ではない。v3.15.0はS86を通常寸法として採用し、v3.14.0の内部機構、レンダリング、照明、影、材質、構造透過、DPR、カメラを維持している。継承した既定照明が実機で暗く見えることは既知事項として、PR #5のD2c3を取り込まずIssue #2の照明最終調整へ申し送る。
