...
現在の改修フェーズは「ムーブメント・文字板の寸法および比率調整」とする。v3.15.0はS86を通常寸法として採用し、v3.14.0の内部機構、レンダリング、照明、影、材質、構造透過、DPR、カメラを維持している。継承した既定照明が実機で暗く見えることは既知事項として、PR #5のD2c3を取り込まずIssue #2の照明最終調整へ申し送る。
