...
## Unreleased — Issue #2 レンダリング品質 Phase 2A.2（Draft比較）

- D2a／D2bの物理iPhone再確認結果を反映。再起動後に従来の黒潰れは解消方向へ改善し、nearの視認性は良好だったが、両候補の見た目の差は小さく、initial／farでは中間調不足、広い暗部、OLED上の強い明暗差が残ったためそのまま採用しない
