...
- `?exterior=balanced`限定の第4候補として、第3候補のケース胴・総厚8.695を維持し、ベゼル／裏蓋リングの見える主環状面を全面テーパー化。
...
- 外装総厚8.695の方向性、ケース胴テーパー、りゅうず位置1／2、指掛かり、pull／push、保持リング方針、透過16%、回転・ズーム、時計機能、作動音、物理iPhone操作性は合格済み。第4候補のベゼル／裏蓋リング全面テーパーと透過50%は人間確認待ち。
...
- 通常pathは固定mainとPNG 237,334 byte／SHA-256 `a114aca62e07f03c9d67e7ada497b05f8007030a8b003f2171e4a8d82555ee5c`で一致。S86、Phase 2C、A.7、機構、ケース胴、カメラ、照明、材質、UI、作動音、APP_VERSIONは変更しない。状態は`IMPLEMENTATION_CANDIDATE_NOT_DEFAULT`のまま、第4候補のPC／物理iPhone確認前に既定採用しない。
