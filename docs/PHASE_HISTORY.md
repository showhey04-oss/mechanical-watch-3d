...
設計と証跡は `MECHANICAL_SOUND_SYSTEM.md` と `evidence/mechanical-operation-sounds/README.md` を参照してください。物理iPhoneでの音量・識別性・遅延・二重発音・復帰動作の人手受入は完了しています。
...
- `CODEX_HANDOFF.md`
- `CODEX_REQUEST.md`
- `REFACTOR_A_SUMMARY.md`
- `REFACTOR_A1_SUMMARY.md`
- `REFACTOR_A2_SUMMARY.md`
- `REFACTOR_A2_INTERFERENCE_REPORT.md`
- `REFACTOR_A3_SUMMARY.md`
- `REFACTOR_A3_TOPOLOGY.md`
- `REFACTOR_A4_SUMMARY.md`
- `REFACTOR_A4_WINDING_TOPOLOGY.md`
- `REFACTOR_A4_FRONT_CONVENTION.md`
- `REFACTOR_A5_SUMMARY.md`
- `REFACTOR_A5_LIGHTING.md`
- `REFACTOR_A5_CAMERA_CONTROLS.md`
- `REFACTOR_A6_SUMMARY.md`
- `FINAL_EXTERIOR_DESIGN_PHASE3C1_WATCH_HEAD.md`
- `FINAL_EXTERIOR_DESIGN_PHASE3C2_STRAP_BUCKLE.md`
- `FINAL_EXTERIOR_INTEGRATION_PHASE3C3.md`
- `ISSUE2_PHASE3C3_INTEGRATION_HANDOFF.md`
- `REFACTOR_A6_FRAME_PACING.md`
- `REFACTOR_A6_CAMERA_SMOOTHING.md`
- `REFACTOR_A7_SUMMARY.md`
- `REFACTOR_A7_KEYLESS_POSITION.md`
- `PR3_UI_ARCHITECTURE.md`
- `PR4_MOBILE_OVERLAY_HUD.md`
- `MECHANICAL_SOUND_SYSTEM.md`
- `FINAL_EXTERIOR_INTEGRATION_PHASE3A_INTERFACE_AUDIT.md`
- `FINAL_EXTERIOR_INTEGRATION_PHASE3B2_LUG_STRAP.md`
...
- PR #31 R2の固定製品Head `9b8369bf9643055de7decaf7df9556c428deff73`はiPhone 16／iOS 26.5.2／Safari／縦向きでHuman受入され、公開名「文字板」の一般化と現行版の文体混在を許容した。後継Rebuildでは文字板の具体名をUI命名規約で決定し、`UI_COPY_STYLE_GUIDE_REQUIRED`として部品・操作・学習・技術・ARIA説明の文体を統一する
