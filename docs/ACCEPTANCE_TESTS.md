...
### Phase 3B.1 E-BALANCED第4全面テーパー候補
...
- ベゼルの保持座幅0.400以下、外周閉合幅1.000以下、主テーパー被覆率0.80以上、外縁厚0.020～0.050、意図しない水平区間0である
- 裏蓋リングが窓径28.548、軸方向包絡4.635～5.235の単一閉合プロファイルで、保持座R14.274～14.474／Y=5.235の直後からR18.900／Y=4.685まで主面全体が単調に傾斜する
- 裏蓋リングの保持座幅0.300以下、外周閉合幅0.700以下、主テーパー被覆率0.80以上、外縁厚0.040～0.080、意図しない水平区間0である
...
- 必要逃げ0.298836、採用逃げ0.319108、上限差0.010892、位置1実gap 0.030026、位置2実gap 1.380026、最小壁厚0.550000を実Geometryから再測定する
...
- 透過16%の人間確認合格を継承し、透過50%は第4候補の人間確認で判断する
