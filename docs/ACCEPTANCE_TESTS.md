...
- ベゼルが表示開口29.800、風防有効径30.600、背面外径38.800、正面外径37.000の単一閉合テーパープロファイルで、内周正面Y=-3.240から外縁正面Y=-2.880へ薄くなる
- 裏蓋リングが前面外径39.000、後面外径37.800、軸方向厚0.600の閉合テーパープロファイルである
...
- 透過16%の人間確認合格を継承し、透過50%は第3候補の人間確認で判断する
