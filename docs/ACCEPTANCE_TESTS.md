...
- 文字板、限定開口地板、ドーム風防がfinite、indexed、closedで、退化・重複・反転triangle、non-manifold edge、非有限法線が0である
- アイボリー文字板、12バーindex、60分目盛、6時小秒、分針12.040、時針8.600、小秒針3.268を実装し、S86中心・回転拘束を変更しない
...
- 状態は`AUTOMATED_PASS_PENDING_PC_AND_PHYSICAL_IPHONE_HUMAN_REVIEW`とし、人間確認前に既定採用、Ready化、マージを行わない
