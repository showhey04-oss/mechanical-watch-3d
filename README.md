...
Phase 3C.1は、人間承認済みPhase 3B.2 Head `98d83781aa7aa001836a0d57f1ad6e3d058a15c4`へ積み上げる別Draftである。`?exterior=balanced&watchHead=phase3c1`時だけ、ポリッシュ主体のケース仕上げ、緩やかなドーム風防、アイボリー文字板、バーインデックス、細身シルバー3針、6時小秒、実テンプ位置へ一致する限定オープンハートを生成する。実テンプ投影は[7.700,1.800]、開口径6.600、文字板面積比3.5559%、中心誤差0で、中央軸受を保持した物理的な地板窓を用いる。機構移動、部品非表示、透明化、CSG、トゥールビヨン風ケージは使用しない。通常URLはPhase 3B.2とpixel exactで、状態は`IMPLEMENTATION_CANDIDATE_NOT_DEFAULT`、PC／物理iPhone人間確認待ちである。黒革、巻込み部、実用長、穴列、定革・遊革、尾錠枠・つく棒・取付バーはPhase 3C.2の必須後続工程として残す。
