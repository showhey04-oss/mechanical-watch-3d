...
- main公開基準：v3.14.0（PR #6 機構同期作動音 Phase 1）
- Draft候補：v3.15.0（S86文字板表示比率、未マージ）
- v3.14.0アプリ実装基準コミット：`90e14647190156d040fbd4aee1e74bf38c3442b3`（現在のmain HEADを固定するものではない）
- 基準形式：ETA 6498-1級の大型手巻きムーブメント
- 公開方式：GitHub Pages
- 現在の改修フェーズ：ムーブメント・文字板の寸法および比率調整
- 版の位置付け：v3.14.0は、v3.13.0の機構・描画基準を維持した音響追加版
...
v3.15.0 Draft候補では、人間確認で選定されたS86の文字板表示寸法だけを実装している。dial ring径27.692、index円径25.456、分針長12.040、時針長8.600、小秒表示円径7.740、小秒針長3.268とし、ムーブメント、四番車軸・小秒中心、Y方向配置、回転拘束、描画・UI・作動音はv3.14.0基準のまま維持する。
