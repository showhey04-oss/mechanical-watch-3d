...
Phase 3C.1は、人間承認済みPhase 3B.2 Head `98d83781aa7aa001836a0d57f1ad6e3d058a15c4`へ積み上げる別Draftである。初回候補は人間確認で非承認となり、`HUMAN_REVIEW_FAILED_PHASE3C1_REVISION_REQUIRED`を記録した。再調整候補は`?exterior=balanced&watchHead=phase3c1`時だけ、暖色アイボリー文字板`#BCAB8E`、明るいシルバーケース、faceted bar index、12時ダブルバー、丸型分目盛、faceted silver hands、blue-steel-tone小秒針、強調したドーム風防、実テンプ位置へ一致するprofiled限定オープンハートを生成する。実テンプ投影は[7.700,1.800]、開口径6.600、文字板面積比3.5559%、中心誤差0で、中央軸受を保持した物理地板窓を用いる。機構移動、部品非表示、透明化、CSG、トゥールビヨン風ケージは使用しない。通常URLはPhase 3B.2とpixel exactで、再調整候補は全自動回帰合格、PC／物理iPhone再確認待ち、既定未採用である。`PHYSICAL_IPHONE_MILD_WARMING_AFTER_15_MIN`は非ブロッキング観察事項として最終15分連続確認へ申し送る。黒革、巻込み部、実用長、穴列、定革・遊革、尾錠枠・つく棒・取付バーはPhase 3C.2の必須後続工程として残す。
